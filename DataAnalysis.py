...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.tree.setGeometry(QtCore.QRect(0, 0, 431, 931))
        self.tree.setAutoExpandDelay(-1)
        self.tree.setObjectName("tree")
        self.tree.headerItem().setText(0, "请选择目标文件夹...")
        self.textEdit = QtWidgets.QTextEdit(self.centralwidget)
        self.textEdit.setGeometry(QtCore.QRect(640, 0, 411, 931))
        self.textEdit.setObjectName("textEdit")
        self.btn_yeild = QtWidgets.QPushButton(self.centralwidget)
        self.btn_yeild.setGeometry(QtCore.QRect(450, 0, 171, 41))
